  ...
  return (
    <div className={style.block_about} id="block-about">
      <div className={style.container}>
        ...
        <p className={style.block_about_text}>Наша команда состоит из высококлассных специалистов с международным опытом работы <br/> в сфере Web-разработки, мобльной разработки, Product менеджмента и дизайна. <br/> Мы предоставляем премиум сервис по доступным ценам и всегда нацелены на успех <br/> наших клиентов.</p>
