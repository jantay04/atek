  ...
  return (
    <div>
      ...
      <div style={{right: open ? "0" : "-254px"}} className={style.sidebar} id="sidebar">
        ...
        <div>
          <li><a className={style.btn_application2 + " " + style.menu_btn} onClick={() => setOpen(false)}
                 href="#block-form">Оставить
            заявку</a></li>
        </div>
        ...
        <div className={style.sidebar_soc}>
          <div><a href="https://www.facebook.com/atekds" target="_blank"><img src={facebook} alt="Icon"/></a></div>
          <div><a href="https://www.instagram.com/atek_ds/" target="_blank"><img src={instagram} alt="Icon"/></a></div>
          <div><a href="https://wa.me/996221123456" target="_blank"><img src={whatsapp} alt="Icon"/></a></div>
          <div><a href="https://t.me/atekds" target="_blank"><img src={telegram} alt="Icon"/></a></div>
          <div><a href="https://www.linkedin.com/company/a-tek-digital-studio" target="_blank"><img src={linkedin} alt="Icon"/></a>
          </div>
        </div>
      </div>
    </div>
